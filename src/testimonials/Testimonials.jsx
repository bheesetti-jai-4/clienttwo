...
import monials from "../store/Testmonials"


const Testimonial = () => {

    const testdata = monials.mintestmonial
    ...
    return (
        <div className=" flex flex-col items-center justify-center p- h-100 ">
            <div className="mt-1  mb-10">
                <h1 className="font-bold text-lg sm:text-xl md:text-2xl lg:text-3xl">Testimonials</h1>
            </div>
                    ...
                    {testdata.map((item, index) => (
                        ...
                        >
                            <img 
                                src={item.image} 
                                alt={item.name} 
                                className="rounded-full h-12 w-12 mb-2 sm:h-16 sm:w-16 md:h-20 md:w-20 lg:h-24 lg:w-24"  
                            />
